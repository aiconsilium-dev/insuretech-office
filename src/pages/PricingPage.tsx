...
function CostRow({ label, value }: { label: string; value: string }) {
  return (
    <div className="flex justify-between py-2.5 border-b border-[#262626] last:border-b-0 text-sm">
  ...
  return (
    <div>
      ...
      <Card variant="outlined" className="!p-4 mt-3">
        <div className="text-sm font-bold mb-3 text-white">주요 공종 단가 미리보기</div>
