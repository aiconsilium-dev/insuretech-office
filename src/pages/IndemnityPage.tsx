    ...
    <div>
      ...
      <Card variant="outlined" className="!p-4 mb-3">
        <div className="flex justify-between items-start mb-1.5">
          <div>
            <div className="font-bold text-[15px] text-[#0a0a0a]">지하주차장 B2 배관 파열</div>
            <div className="text-xs text-[#a3a3a3] mt-0.5">2026.03.15 | 관리사무소 접수</div>
          </div>
          <Badge variant="primary" className="!text-[10px]">경합</Badge>
        </div>
        <div className="text-[13px] text-[#737373] leading-relaxed mt-2">
      ...
      <Card variant="outlined" className="!p-4 mb-3">
        <div className="flex justify-between items-start mb-1.5">
          <div>
            <div className="font-bold text-[15px] text-[#0a0a0a]">엘리베이터 도어 파손</div>
            <div className="text-xs text-[#a3a3a3] mt-0.5">2026.02.28 | 입주민 접수</div>
          </div>
